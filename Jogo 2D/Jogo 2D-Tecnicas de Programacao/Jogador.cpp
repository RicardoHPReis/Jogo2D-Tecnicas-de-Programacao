...
void Jogador::inicTexturasP()
{
	...
	//texturas Player
	for (i = 0; i < 10; i++) {
		if (!this->tPlayerCorre[i].loadFromFile("C:/Users/Usuario/source/repos/Jogo 2D-Tecnicas de Programacao/Texturas/Personagens/Cavaleiro/Correr.png", IntRect(99.f + (i * 580.f), 30.f, 460.f, 660.f))) {
			std::cout << "ERROR";
		}
		this->tPlayerCorre[i].setSmooth(true);

		if (!this->tPlayerPula[i].loadFromFile("C:/Users/Usuario/source/repos/Jogo 2D-Tecnicas de Programacao/Texturas/Personagens/Cavaleiro/Pular.png", IntRect(51.f + (i * 588.f), 30.f, 470.f, 626.f))) {
			std::cout << "ERROR";
		}
		this->tPlayerPula[i].setSmooth(true);

		if (!this->tPlayerParado[i].loadFromFile("C:/Users/Usuario/source/repos/Jogo 2D-Tecnicas de Programacao/Texturas/Personagens/Cavaleiro/Parado.png", IntRect(51.f + (i * 588.f), 30.f, 448.f, 626.f))) {
			std::cout << "ERROR";
		}
